const tokenUrl = (code: string): string => {
  ...
  const codeVerifier = 'QYPAZ5NU8yvtlQ9erXrUYR-T5AGCjCF47vN-KsaI2A8';//'qPsH306-ZDDaOE8DFzVn05TkN3ZZoVmI_6x4LsVglQI';
  ...
  //return `http://localhost:9000/oauth2/token?client_id=${clientId}&redirect_uri=${redirectUri}&grant_type=${grantType}&code=${code}&code_verifier=${codeVerifier}`;
};
